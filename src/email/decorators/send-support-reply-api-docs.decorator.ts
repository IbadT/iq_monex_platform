      ...
      schema: {
        ...
        properties: {
          ...
          message: {
            ...
            example: 'Здравствуйте! Ваше обращение рассмотрено. Проблема связана с...',
          },
          agentName: {
            type: 'string',
            minLength: 2,
      ...
      examples: {
        standardReply: {
          ...
          value: {
            ...
            message: 'Здравствуйте! Ваше обращение по поводу проблемы с входом в систему рассмотрено. Мы обнаружили техническую неполадку и уже исправили ее. Пожалуйста, попробуйте войти снова. Если проблема сохранится, сообщите нам.',
        ...
        technicalSolution: {
          ...
          value: {
            ...
            message: 'Добрый день! Проанализировав ваш запрос, мы выяснили, что проблема связана с неверной конфигурацией браузера. Пожалуйста, очистите кэш и cookies, затем перезагрузите страницу. Если это не поможет, попробуйте использовать другой браузер.',
        ...
        billingQuestion: {
          ...
          value: {
            ...
            message: 'Здравствуйте! Касательно вашего вопроса о списании средств - мы проверили транзакцию и обнаружили ошибку. Средства будут возвращены на ваш счет в течение 3-5 рабочих дней. Приносим извинения за неудобства.',
