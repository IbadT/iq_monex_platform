...
describe('FavoritesController', () => {
  ...
  beforeEach(async () => {
    ...
    favoritesService = module.get<jest.Mocked<FavoriteService>>(FavoriteService);
  });
  ...
  describe("getById", () => {
    it("should return favorite by id", async () => {
      ...
      const response = await controller.getFavorites("123-e456-7890-abcd-ef1234567890");
      
      expect(favoritesService.getById).toHaveBeenCalledWith("123-e456-7890-abcd-ef1234567890");
