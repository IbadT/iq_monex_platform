import { FavoriteUserProfileResponseDto, UserProfileDto, UserDto } from '../dto/response/favorite-user-profile-response.dto';

export class FavoriteUserMapper {
  static toResponse(favorite: any): FavoriteUserProfileResponseDto {
    const userProfile = favorite.targetUser?.profile ? new UserProfileDto(
