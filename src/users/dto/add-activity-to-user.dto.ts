...
export class AddActivityToUserDto {
  @ApiProperty({
    description:
      'ID существующей активности (если указан, используется существующая активность)',
    example: 1,
    required: false,
  })
  @IsOptional()
  ...
  @ApiProperty({
    description:
      'Название новой активности (если указано, создастся новая активность и присвоится пользователю)',
